...
import it.unibo.inner.api.GenericPourpose;
...
public class TestIterableWithPolicy {
    ...
    private static <T> IterableWithPolicy<T> makeIterableWithPolicy(final T[] elements, final Predicate<T> filter) {
        return new GenericPourpose<>(elements,filter);//null; // TODO: return the implementation of IterableWithPolicy
    }

    private static <T> IterableWithPolicy<T> makeIterableWithPolicy(final T[] elements) {
        return new GenericPourpose<>(elements);//null; // TODO: return the implementation of IterableWithPolicy
    }
